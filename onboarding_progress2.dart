...
class _OnboardingProgressScreenState extends State<OnboardingProgressScreen>
  ...
  int _choiceLanguageIndex = -1;
  int _choiceLanguageLevelIndex = -1;
  int _choiceLanguageReasonIndex = -1;
  int _choiceTimePracticeIndex = -1;
  final Set<int> _selectedSkillsIndexs = {};
  final Set<int> _selectedTopicsIndexs = {};
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: () {
                  _choiceLanguageIndex = index;
                  _choiceLanguage = languagesData[index].id;
                  _goToNextLevel();
                },
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: (index == _choiceLanguageIndex)
                  ...
                  child: Stack(
                    children: [
                      Padding(
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              Image.network(languagesData[index].icon ?? "",
                                  width: 40, height: 40),
                              const SizedBox(height: 10),
                              Text(
                                languagesData[index].title,
                                style: TextStyle(
                      ...
                      if (!otherLanguagesData[index].enable)
                        GestureDetector(
                          onTap: () {
                            ...
                            showDisableLanBSH(
                                ...
                                title: "Comming Soon",
                                text:
                                    "${languagesData[index].title} Language is currently disabled. ${languagesData[index].title} will be added to the list of Number1 languages, soon.",
                                icon: languagesData[index].icon!);
                          },
                          child: Container(
                            padding: const EdgeInsets.symmetric(
                                vertical: 10, horizontal: 10),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Text(
                      'What is your ${(_choiceLanguageIndex != -1) ? languagesData[_choiceLanguageIndex].title : languagesData[0].title} level?',
                      textAlign: TextAlign.start,
        ...
        Expanded(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: () {
                  _choiceLanguageLevelIndex = index;
                  _choiceLanguageLevel = levels[index].id;
                  _goToNextLevel();
                },
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(
                      color: (index == _choiceLanguageLevelIndex)
                          ? AppColors.appcolors_blue1
                          : AppColors.appcolors_pinky,
                    ),
                  ),
          ...
          Row(
            ...
            children: [
              ...
              Flexible(
                ...
                child: Text(
                  'What is your primary reason for learning ${(_choiceLanguageIndex != -1) ? languagesData[_choiceLanguageIndex].title : ""}?',
                  textAlign: TextAlign.start,
                  style: const TextStyle(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
          ...
          Column(
            children: List.generate(
              ...
              (index) {
                return GestureDetector(
                  onTap: () {
                    _choiceLanguageReasonIndex = index;
                    _choiceLanguageReason = reasons[index].id;
                    _goToNextLevel();
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: (index == _choiceLanguageReasonIndex)
                            ? AppColors.appcolors_blue1
                            : AppColors.appcolors_pinky,
                      ),
                    ),
          ...
          Column(
            children: List.generate(
              ...
              (index) {
                return GestureDetector(
                  onTap: () {
                    _choiceTimePracticeIndex = index;
                    _choiceTimePractice = timePractice[index].id;
                    _goToNextLevel();
                  },
                  child: Container(
                    margin:
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: (index == _choiceTimePracticeIndex)
                            ? AppColors.appcolors_blue1
                            : AppColors.appcolors_pinky,
                      ),
                    ),
        ...
        children: [
          ...
          Column(
            children: List.generate(
              skills.length,
              (index) {
                final isSelected = _selectedSkillsIndexs.contains(index);
                return GestureDetector(
                  onTap: () {
                    setState(() {
                      if (isSelected) {
                        _selectedSkillsIndexs
                            .remove(index); // Deselect if selected
                        _selectedSkills.remove(skills[index].id);
                      } else {
                        _selectedSkillsIndexs
                            .add(index); // Select if not selected
                        _selectedSkills.add(skills[index].id);
                      }
                    });
                  },
                  child: Container(
            ...
            child: Align(
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    _selectedSkillsIndexs.isNotEmpty ? _goToNextLevel() : null;
                  },
                  style: ElevatedButton.styleFrom(
                    foregroundColor: Colors.white,
                    minimumSize: const Size(double.infinity, 50),
                    backgroundColor: _selectedSkillsIndexs.isNotEmpty
        ...
        children: [
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 5),
                const Flexible(
                  child: Text('Which topics would you love?',
                      textAlign: TextAlign.start,
                      style: TextStyle(
                        fontSize: 22,
                        fontWeight: FontWeight.bold,
          ...
          Positioned(
            ...
            child: SingleChildScrollView(
              child: Wrap(
                ...
                runSpacing: 10, // فاصله عمودی بین خطوط
                children: List.generate(
                  topics.length,
                  (index) {
                    final isSelected = _selectedTopicsIndexs.contains(index);
                    return GestureDetector(
                      onTap: () {
                        setState(() {
                          if (isSelected) {
                            _selectedTopicsIndexs.remove(index);
                            _selectedTopics.remove(topics[index].id);
                          } else {
                            _selectedTopicsIndexs.add(index);
                            _selectedTopics.add(topics[index].id);
                          }
                        });
                      },
                      child: Container(
          ...
          Positioned(
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  _selectedTopicsIndexs.isNotEmpty ? _goToNextLevel() : null;
                },
                style: ElevatedButton.styleFrom(
                  foregroundColor: Colors.white,
                  minimumSize: const Size(double.infinity, 50),
                  backgroundColor: _selectedTopicsIndexs.isNotEmpty
                      ? AppColors.appcolors_blue2
                      : Colors.grey,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15.0),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  Text(text, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: Colors.black54),),
                  const SizedBox(height: 20),
                ],
              ),
            ),
